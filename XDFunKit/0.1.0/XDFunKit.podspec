#
# Be sure to run `pod lib lint XDFunKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'XDFunKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XDFunKit.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'XDFunKit/Classes/**/*'
  
  # s.resource_bundles = {
  #   'XDFunKit' => ['XDFunKit/Assets/*.png']
  # }
